            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                <div>
                  ...
                  Secara sederhana, kata resolusi diartikan sebagai suatu keputusan atau ketetapan hati. Sehingga, resolusi tahun baru artinya adalah suatu keputusan yang berdasar pada ketetapan hati dan diagendakan untuk dilakukan pada tahun yang baru
                  </p>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
