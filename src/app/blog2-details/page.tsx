...
export const metadata: Metadata = {
  ...
  description: "Stay Connected: Menangani Perasaan Kesepian selama Ujian",
  // other metadata
};
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h2 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">
                  Stay Connected: Menangani Perasaan Kesepian selama Ujian
                </h2>
                <div className="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                    ...
                    <div className="mb-5 mr-10 flex items-center">
                      ...
                      <div className="w-full">
                        <span className="mb-1 text-base font-medium text-body-color">
                          By <span>konselingmakaraui</span>
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="mb-5">
                    <a
                      href="#0"
                      className="inline-flex items-center justify-center rounded-full bg-yellow_bright px-4 py-2 text-sm font-semibold text-black"
                    >
                      Psychology
                    </a>
                  </div>
